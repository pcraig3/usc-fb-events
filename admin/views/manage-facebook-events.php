<?php
/**
 * Manage_Facebook_Events class is one that extends the AdminPageFramework and creates a backend WordPress page
 * I admit I've gone a bit over the head of vanilla WordPress in loading the events via Ajax in a list at the
 * top of the page, but the settings underneath (to modify an event) are all done rightly enough using the
 * Admin Page Framework and the way it's currently set up, everything plays nice with everything else.
 */
...
class Manage_Facebook_Events extends AdminPageFramework {
    ...
    public function setUp() {
        ...
        //first thing defined in Event Organiser by Stephen Harris
        // @see: https://github.com/stephenharris/Event-Organiser/blob/master/event-organiser.php
        if( defined( 'EVENT_ORGANISER_VER' ) )
            $this->setRootMenuPageBySlug( 'edit.php?post_type=event' );
        else
            $this->setRootMenuPage( 'Events' );
        ...
        $this->addSettingFields(
            ...
            /**
             * Note: the old ticket value (if there is no new ticket) shows up in the new ticket slot
     ...
     *
     * Prints out the event list and input buttons/fields/checkboxes for our filter.js plugin.
     * Events loaded in this table will be able to be searched and filtered.
     *
     * @remark  this is a pre-defined framework method
     *
    ...
    public function validation_manage_facebook_events_page( $aInput, $aOldInput ) {	// validation_{page slug}
        ...
        //If 'Reset Modifications' was clicked, then just delete the record stored in our database
        ...
        */
        ...
        //Note: This 'modifies' events even if there are no updated values present.
